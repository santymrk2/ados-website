...
import { SexBadge, RankBadge, PodiumBadge } from "../ui/Badges";
...
// Métricas disponibles para el ranking
...
export function DashboardView({
  ...
  setShowRanking,
  showTopGoleadores,
  setShowTopGoleadores,
  topGoleadoresGender,
  setTopGoleadoresGender,
  onLogout,
  onActivityClick,
}) {
  ...
  // Obtener la métrica actual para mostrar
  const currentMetric =
    RANKING_METRICS.find((m) => m.key === rankingMetric) || RANKING_METRICS[0];
  ...
  return (
    <div>
      ...
      <div className="p-4">
        ...
        {showRanking && (
          <>
            {/* Pills para seleccionar métrica */}
